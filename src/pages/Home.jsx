      ...
      <div id="home" className="relative flex flex-col items-center justify-center min-h-[80vh] px-4 text-white">
        ...
        <div className="relative z-10 flex flex-col items-center animate-fade-in-up">
          ...
          <p className="text-xl sm:text-2xl max-w-2xl mx-auto mb-8 font-medium text-indigo-100 drop-shadow">
            Full‑Stack Developer building performant web, mobile, and desktop apps with <span className="text-indigo-300 font-semibold">React</span>, <span className="text-indigo-300 font-semibold">React Native</span>, and <span className="text-indigo-300 font-semibold">Electron</span>.
          </p>
